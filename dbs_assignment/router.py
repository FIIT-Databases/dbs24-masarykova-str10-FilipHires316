...
router.include_router(badge.router, tags=["posts"])
router.include_router(comments.router, tags=["posts"])
router.include_router(position.router, tags=["posts"])
router.include_router(postid.router, tags=["posts"])
